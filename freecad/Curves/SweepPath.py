...
class PathInterpolation:
    ...
    def extend(self, periodic=False):
        ...
        self.profiles.append(SweepProfile(p1.Curve, p1.Parameter + path_range))
        self.profiles.append(SweepProfile(p0.Curve, p0.Parameter - path_range))
