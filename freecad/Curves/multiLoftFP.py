...
class MultiLoftFP:
    ...
    def __init__(self, obj):
        ...
        obj.addProperty(
            ...
            "Sources",
            "Multiloft",
            QT_TRANSLATE_NOOP("App::Property", "Objects to loft"),
        )
        obj.addProperty(
            "App::PropertyBool",
            "Ruled",
            "Multiloft",
            QT_TRANSLATE_NOOP("App::Property", "Ruled Loft"),
        ).Ruled = False
        obj.addProperty(
            "App::PropertyBool",
            "Closed",
            "Multiloft",
            QT_TRANSLATE_NOOP("App::Property", "Close loft"),
        ).Closed = False
        obj.addProperty(
            "App::PropertyInteger",
            "MaxDegree",
            "Multiloft",
            QT_TRANSLATE_NOOP("App::Property", "Max Bspline degree"),
        ).MaxDegree = 5
        obj.Proxy = self
